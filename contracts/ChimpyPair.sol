...
import './interfaces/IChimpyPair.sol';
import './ChimpyERC20.sol';
import './libraries/Math.sol';
import './libraries/UQ112x112.sol';
import './interfaces/IERC20.sol';
import './interfaces/IChimpyFactory.sol';
import './interfaces/IChimpyCallee.sol';
...
contract ChimpyPair is IChimpyPair, ChimpyERC20 {
    ...
    function swap(uint amount0Out, uint amount1Out, address to, bytes calldata data) external lock {
        ...
        require(balance0Adjusted.mul(balance1Adjusted) >= uint(_reserve0).mul(_reserve1).mul(1000**2), 'ChimpySwap: K');
        }
